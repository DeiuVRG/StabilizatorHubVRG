...
- **Mod demo** („View live demo" pe pagina de login): sesiune read-only pe un stabilizator simulat care emite telemetrie realistă prin pipeline-ul real (istoric 30 de zile, curbă zilnică de consum, căderi/vârfuri de tensiune programate) — ideal pentru prezentare, fără cont și fără hardware.
