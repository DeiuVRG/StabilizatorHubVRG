        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceId = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PairingCodeHash = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    FirmwareVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    IsOnline = table.Column<bool>(type: "INTEGER", nullable: false),
                    OutputOn = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastSeenUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastTelemetryUtc = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimestampUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    VoltageIn = table.Column<double>(type: "REAL", nullable: false),
                    VoltageOut = table.Column<double>(type: "REAL", nullable: false),
                    CurrentAmps = table.Column<double>(type: "REAL", nullable: false),
                    PowerWatts = table.Column<double>(type: "REAL", nullable: false),
                    EnergyWh = table.Column<double>(type: "REAL", nullable: false),
                    OutputOn = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtremeVoltage = table.Column<double>(type: "REAL", nullable: false),
                    SampleCount = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoltageEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VoltageEvents_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Readings_DeviceId_TimestampUtc",
                table: "Readings",
                columns: new[] { "DeviceId", "TimestampUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_VoltageEvents_DeviceId_EndedAtUtc",
                table: "VoltageEvents",
                columns: new[] { "DeviceId", "EndedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_VoltageEvents_DeviceId_StartedAtUtc",
                table: "VoltageEvents",
